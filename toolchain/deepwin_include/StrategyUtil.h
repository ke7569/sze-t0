...
class StrategyUtil;
typedef boost::shared_ptr<StrategyUtil> StrategyUtilPtr;
...
public:
    void set_cc(IControlCenter *p){
        cc = p;
    }

    IControlCenter *get_cc(){
        return cc;
    }

    void set_rids(int s, int e){
        rid_start = s;
        rid_end = e;
    }
...
public:
    ...
    static JournalPair getMdJournalPair(short source);
    //static JournalPair getMdRawJournalPair(short source);
    static JournalPair getTdJournalPair(short source);
    static JournalPair getTdSendJournalPair(short source);
    //static JournalPair getTdRawJournalPair(short source);
    //static JournalPair getTdQJournalPair(short source);
    static std::vector<short> get_source_ids();
